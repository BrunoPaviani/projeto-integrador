            ...
            <div className="p-grid">
                <div className="p-col-12">
                    <div className="card docs">
                        ...
                        <p>Uniasselvi is an application template for React based on the popular <a href="https://github.com/facebookincubator/create-react-app">create-react-app</a> that allows
                            creating React apps with no configuration. To get started, clone the <a href="https://github.com/primefaces/lida">repository</a> from GitHub and install the dependencies with npm or yarn.</p>
                        <pre>
{
`npm install
`}
...
`}
                        ...
                        <p>Next step is running the application using the start script and navigate to <b>http://localhost:3000/</b> to view the application.
                            That is it, you may now start with the development of your application using the Lida template.</p>
...
`}
                        ...
                        <h1>Structure</h1>
                        <p>Lida consists of 2 main parts; the application layout and the resources. <b>App.js</b> inside src folder is the main component containing the template for the base layout
...
`}
                        ...
                        <p>Dependencies of Lida are listed below and needs to be added to package.json. Only required
...
`
                        ...
                        <h1>Nova Theme</h1>
                        <p>Lida uses the free Nova-Light theme of PrimeReact which is a free theme distributed within PrimeReact, however it can be used with any PrimeReact theme.</p>
...
&lt;div className="layout-sidebar layout-sidebar-light"&gt;
                        ...
                        <h1>Grid CSS</h1>
                        <p>Lida uses PrimeFlex CSS Grid throughout the samples. Although any grid library can be used, we recommend using PrimeFlex as your layout framework as it is well tested and supported by PrimeVue. PrimeFlex is
